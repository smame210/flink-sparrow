 ...
 * @date 2024/9/10
 */
public class KafkaValueStringDeserializationSchema implements KafkaDeserializationSchema<DataRecord> {
    ...
    public DataRecord deserialize(ConsumerRecord<byte[], byte[]> consumerRecord) throws Exception {
        if (consumerRecord.value() != null) {
            ...
            return new DataRecord(Map.of("topic", consumerRecord.topic()), Map.of("value", data));
        }
        return null;
    }
